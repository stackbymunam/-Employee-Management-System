...
const Failedtask = ({ data }) => {
  return (
    <div className='w-full sm:w-72 md:w-80 shrink-0'>
      <div className='p-5 bg-red-700 rounded-xl h-full'>

        <div className='flex justify-between items-center mt-5 text-white'>
          <h3 className='bg-red-900 text-sm px-3 py-1 rounded'>{data.category}</h3>
        ...
        <div className='mt-4'>
          <button className='w-full bg-red-900 text-white py-1 px-2 text-sm rounded'>
            Failed
          </button>
        </div>
